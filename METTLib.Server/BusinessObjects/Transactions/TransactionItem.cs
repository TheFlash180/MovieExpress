// Generated 20 Jul 2021 11:18 - Singular Systems Object Generator Version 2.2.694
//<auto-generated/>
using System;
using Csla;
...
namespace MELib.TransactionItems
{
     ...
     : MEBusinessBase<TransactionItem>
    {
        ...
        public static PropertyInfo<int> TransactionItemIDProperty = RegisterProperty<int>(c => c.TransactionItemID, "ID", 0);
        /// <summary>
        /// Gets the ID value
        /// </summary>
        ...
        {
            get { return GetProperty(TransactionItemIDProperty); }
        }
        ...
        public static PropertyInfo<String> ProductNameProperty = RegisterProperty<String>(c => c.ProductName, "ProductName");
        /// <summary>
        /// Gets and sets the Product value
        /// </summary>
        [Display(Name = "Product", Description = ""),
        ...
        {
            return GetProperty(TransactionItemIDProperty);
        }
        ...
        protected void Fetch(SafeDataReader sdr)
        {
            ...
            {
                int i = 0;
                LoadProperty(TransactionItemIDProperty, sdr.GetInt32(i++));
        ...
        protected override Action<SqlCommand> SetupSaveCommand(SqlCommand cm)
        {
            ...
            AddPrimaryKeyParam(cm, TransactionItemIDProperty);
            ...
            return (scm) =>
            {
                ...
                if (this.IsNew)
                {
                    LoadProperty(TransactionItemIDProperty, scm.Parameters["@TransactionItemID"].Value);
                }
            };
        }
        ...
        {
            cm.Parameters.AddWithValue("@TransactionItemID", GetProperty(TransactionItemIDProperty));
        }
